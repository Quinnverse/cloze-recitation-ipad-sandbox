...
(function (RT) {
  ...
  function bind() {
    ...
    document.addEventListener('touchend', function (e) {
      ...
      clearTimeout(lpTimer);
      if (activeHandle) {
        activeHandle = null; tpAnchor = null; tpAnchorOff = null; tpHitToken = null;
        suppressPaperClickUntil = Date.now() + 800;
        return;
      }
    ...
    document.addEventListener('touchcancel', function () {
      clearTimeout(lpTimer);
      tpAnchor = null; tpAnchorOff = null; tpHitToken = null; tpDragging = false; tpLongPress = false; activeHandle = null;
      var p = $('#paper'); if (p) p.classList.remove('dragging');
      clearSelPop(); clearHighlight();
    }, { passive: true });
