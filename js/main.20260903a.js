...
(function (RT) {
  ...
  function bind() {
    ...
    document.addEventListener('touchstart', function (e) {
      ...
      tpAnchor = caretPoint(t.clientX, t.clientY);
      // 清除上一次残留高亮
      clearHighlight();
      ...
      lpTimer = setTimeout(function () {
        ...
        var tokenEl = anchorEl && closestEl(anchorEl, '.tk');
    ...
    document.addEventListener('touchend', function (e) {
      ...
      if (tpDragging) {
        ...
        tpDragging = false; tpLongPress = false; tpAnchor = null; return;
      }
      // 未拖选：长按但未移动 → 清除；或点空白收起浮层
      tpLongPress = false; tpAnchor = null;
